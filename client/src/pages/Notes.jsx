            ...
            <AnimatePresence>
              {suggestions.length > 0 && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: -10 }}
                  className={`absolute mt-2 w-full rounded-xl shadow-2xl z-50 ${
                    ...
                    >
                      ...
                      {note.isPublic && (
                        <motion.span
                          ...
                          className="inline-block mt-3 px-3 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800"
                        >
                          Public
                        </motion.span>
                      )}
